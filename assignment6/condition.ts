...
let equalString:string = "Lahore"
if(equalString === "Lahore"){
    console.log( "Equal : " + true);
    
}
let unequalString:string = "Lahore"
...
let result : string = equalString.toLowerCase();
if(result === "Lahore"){
    console.log(true);  
}
else{
...
let arrayOfnumber: number[] = [1 ,2 ,3 ,4 ,5 ,6 ,7 ,8];
...
let arrayOfnumbers: number[] = [1 ,2 ,3 ,4 ,5 ,6 ,7 ,8];
